...
class CLAPWrapper():
    ...
    def preprocess_audio(self, audio_files, resample, duration):
        ...
        for audio_file in audio_files:
            if isinstance(audio_file,str):
                ...
                audio_tensor = self.resample_and_duration(audio_file, duration, resample)
            else: 
    ...
    def get_audio_embeddings(self, audio_files, resample, duration):
        r"""Load list of audio files and return a audio embeddings"""
        preprocessed_audio = self.preprocess_audio(audio_files, resample, duration)
